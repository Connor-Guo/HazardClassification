...
df_train = load_pickle("./out/datasets/guanzhi_sep_vec_each_1000-train.pkl")
df_test = load_pickle("./out/datasets/guanzhi_sep_vec_each_1000-test.pkl")
# sentences = df['后果'].tolist()
# labels = (df['label'] - 1).tolist()
